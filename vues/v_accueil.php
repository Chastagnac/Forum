   ...
   <section class="contact" id="contact">
      ...
      <div class="row">
         ...
         <div class="bestTopics">
            <h3>Articles <span>Recents</span></h3>
            <ul class="list">
               <li><img src="../images/affiches/3page-img1.jpg" alt="" /><a href="article.html">Article 1</a><br />
                  Description is to be here. Since we have no idea what your article is about, we just put standard<br />
               </li>
               <li><img src="../images/affiches/3page-img2.jpg" alt="" /><a href="article.html">Article 2</a><br />
                  Description is to be here. Since we have no idea what your article is about, we just put standard<br />
               </li>
               <li><img src="../images/affiches/3page-img3.jpg" alt="" /><a href="article.html">Article 3</a><br />
                  Description is to be here. Since we have no idea what your article is about, we just put standard<br />
               </li>
            </ul>
         </div>
